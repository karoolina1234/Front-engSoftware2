...
function AreaUsuario (){
    ...
    return(
        ...
        <nav class="col-md-2  sidebar">
            ...
            <ul class="nav flex-column">
              <li class="nav-item">
                ...
                <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z"/>
                  ...
                  Dados pessoais <span class="sr-only">(current)</span>
          ...
          <h1 className="text-center">Olá {user.name}</h1>

          <h4 className="text-center">Seus dados pessoais são:</h4>
          <div className="dados-cliente">
                <h5>Email cadastrado : {user.email}</h5>
                <h5>Telefone para contato: {user.celular}</h5>
                <h5>Endereço cadastrado</h5>
                <h5>Rua: {user.rua} Numero: {user.numero}</h5>
                <h5>Cidade: {user.cidade}</h5>
